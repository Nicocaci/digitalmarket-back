...
const Contacto = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    e.preventDefault();
        ...
        emailjs.sendForm('service_owbp44t', 'template_f02dt4j', form.current, 'BOrfBHSq-UsH597J3')
      .then(() => {
  ...
  return (
    <section>
    <div>
      <h1 className='center titulo-contacto'>Contacto</h1>
      <div className='center contactoData'>
        <div>
          <div className='center wpp'>
            ...
            <p className='text-contacto'>5491173660802</p>
          </div>
        </div>
        <div>
          <div className='center wpp'>
        ...
        <div>
          <div className='center wpp'>
            ...
            <p className='text-contacto'>digital-market@gmail.com</p>
          </div>
        </div>
        <div>
          <div className='center wpp'>
            ...
            <p className='text-contacto'>Calle 153 n° 3987 - Plátanos</p>
          </div>
        </div>
      </div>
    </div>
